...
namespace DependencyInjection.SourceGenerator.Microsoft.Diagnostics
{
    public static class MethodRegistrationDiagnostics
    {
        ...
        private static readonly DiagnosticDescriptor MustBePublicOrInternal = new DiagnosticDescriptor(
            "DI002",
            "Method Registration",
        ...
        private static readonly DiagnosticDescriptor InvalidParameters = new DiagnosticDescriptor(
            "DI003",
            "Method Registration",
        ...
        private static readonly DiagnosticDescriptor CannotReturnVoid = new DiagnosticDescriptor(
            "DI004",
            "Method Registration",
        ...
        private static readonly DiagnosticDescriptor MustHaveIServiceCollectionParameter = new DiagnosticDescriptor(
            "DI005",
            "Method Registration",
